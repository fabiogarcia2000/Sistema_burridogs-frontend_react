        ...
        <div className="row">
            <div className="col-lg-6 col-12 mx-auto">
                <div className="text-center image-size-small position-relative">
                    <img src="https://img.freepik.com/vector-premium/terminal-pos-recibo-banco-pago-terminal-procesamiento-nfc-pago-dispositivo-vector-icono_660702-26.jpg?w=740" className="rounded-circle p-2 bg-white"/>
                    <div className="icon-camera">
                    <Link to="" className="text-primary"><i className="lni lni-camera"></i></Link>
                    </div>
                </div>
