...
const getRegistros = async (fechas) => {
  try {
    console.log(fechas)
    const res = await axios.post(UrlConsultar, {fechas});
    ...
    <div className="container">
      ...
      <br />
        ...
        onSubmit={async (valores) => {
          try {
            console.log(valores)
            const res = await axios.post(UrlConsultar, valores);
            setMostrar2(res.data)
            console.log(res)
          } catch (error) {
            console.log(error);
          ...
          <Form>
            ...
            <div className="row g-3">
              ...
              <div className="col-2 bottom-aligned">
                <button className="btn btn-primary me-2" type="reset">
                    Consultar
                </button>
