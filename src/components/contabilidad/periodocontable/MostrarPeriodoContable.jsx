    ...
    try {
      ...
      if (res.status === 200) {
        ...
        RegistroEnVitacora(
          permisos[0].id_objeto,
          "ELIMINAR",
          "ERROR ELIMINAR PERIODO CONTABLE"
        );
      }
    } catch (error) {
      console.log(error);
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      RegistroEnVitacora(
                        permisos[0].id_objeto,
                        "EXPORTAR",
                        "EXPORTAR EXCEL PERIODO CONTABLE"
                      );
                    }}
                  >
