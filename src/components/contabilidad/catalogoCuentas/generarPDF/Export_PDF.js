...
export function Export_PDF (data) {
    ...
    const datos = data.map((elt,i) => [(i+1), elt.nombre_usuario, elt.codigo_cuenta, elt.nombre_cuenta, elt.nombre_categoria, elt.descripcion]);
    ...
    let reporte = "CATÁLOGO DE CUENTAS";
    let espacio = " ";
