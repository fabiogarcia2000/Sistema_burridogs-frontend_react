        ...
        <>
          <Link
            ...
            onClick={() => {
              ...
              InsertarBitacora(permisos[0].id_objeto, "LECTURA", "MOSTRAR MAS IMPUESTO")
            }}
          >
            ...
            >
              <Button
                ...
                onClick={()=>{
                  ...
                  InsertarBitacora(permisos[0].id_objeto, "EXPORTAR", "EXPORTAR EXCEL IMPUESTO")
                }}
              >
              ...
              <Button
                ...
                onClick={()=>{
                  Export_PDF(results);
                  InsertarBitacora(permisos[0].id_objeto, "EXPORTAR", "EXPORTAR PDF IMPUESTO")
                }}
              >
