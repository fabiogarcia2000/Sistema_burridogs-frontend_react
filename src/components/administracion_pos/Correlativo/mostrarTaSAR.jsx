...
const MostrarTalonarioSAR = () => {
  ...
  const TienePermisos = () =>{
    ...
    InsertarBitacora(permisos[0].id_objeto, "LECTURA", "CONSULTAR CORRELATIVOS")
  }
/*******************/
  ...
  const deleteRegistro = async () => {
    try {
      ...
      if (res.status === 200) {
         ...
         InsertarBitacora(permisos[0].id_objeto, "ELIMINAR", "ELIMINAR CORRELATIVO");
      } else {
        ...
        <>
          <Link
            ...
            onClick={() => {
              ...
              InsertarBitacora(permisos[0].id_objeto, "LECTURA", "MOSTRAR MAS CORRELATIVO")
            }}
          >
              ...
              <button
                ...
                onClick={() => {
                  if(permisos[0].permiso_insercion){
                    navigate("/admin/creartalonarioSAR")
                  }else{
                   mostrarAlertas("permisos");
                  }              
                }}
            ...
            >
              <Button
                ...
                onClick={()=>{
                  ...
                  InsertarBitacora(permisos[0].id_objeto, "EXPORTAR", "EXPORTAR EXCEL CORRELATIVO")
                }}
              >
              ...
              <Button
                ...
                onClick={()=>{
                  Export_PDF(results);
                  InsertarBitacora(permisos[0].id_objeto, "EXPORTAR", "EXPORTAR PDF CORRELATIVO")
                }}
              >
