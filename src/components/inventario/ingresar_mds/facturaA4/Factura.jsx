...
export default function Factura() {
  ...
  const [venta] = useGlobalState("dataCompra");
        ...
        <div className="col-7">
          ...
          <div className="row">
            ...
            <div>
              ...
              <br />
              <span>{"C.A.I: " + (venta.cai || "")}</span>
              <br />
              <strong>{"RANGO AUTORIZADO DEL: " + (venta.rango || "")}</strong>
              <br />
              <span>
                {"Fecha Limite de Emisión: " +
                  (venta.fecha_limite_emision || "")}
              </span>
              <br />
            </div>
          </div>
        ...
        <div className="col">
          <div className="row text-center">
            ...
            <h5>
              ...
              <strong>{venta.no_factura || ""}</strong>
            </h5>
          </div>
          <br /> <br />
          <div className="row text-center">
              ...
              <table class="table table-sm table-bordered border-dark table-responsive">
                <tbody className="text-end">
                  ...
                  <tr>
                    ...
                    <td>
                      <strong>{"L. " + (venta.venta_total || 0)}</strong>
                    </td>
                  </tr>
                </tbody>
              </table>
