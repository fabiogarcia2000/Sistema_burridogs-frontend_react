...
export function Export_PDF (data) {
    ...
    const encabezado = [["#", "USUARIO","NOMBRE","ESTADO", "ROL", "FECHA DE VENCIMIENTO","CORREO"]];
   
    //Registros de la tabla
    const datos = data.map((elt,i) => [(i+1), elt.usuario, elt.nombre_usuario, elt.descripcion, elt.rol, elt.fecha_vencimiento, elt.correo_electronico]);
